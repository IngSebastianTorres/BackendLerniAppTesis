...
public class ActividadDisciplinariaService {
	...
	@RestController public class ControllerRegex { @RequestMapping(value="/{text:[a-z-]+}.{number:[\\d]+}") public String regularExpression(@PathVariable String text, @PathVariable String number){ return "Got your text and number !!"; } }
